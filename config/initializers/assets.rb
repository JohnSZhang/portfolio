...
Rails.application.config.assets.precompile += %w( jquery.min.js skel.min.js static.js.coffee init.js )
Rails.application.config.assets.precompile += %w( skel.css font-awesome.min.css skel.scss _vars.scss _mixins.scss style-normal.scss style-normal.css style.css)
